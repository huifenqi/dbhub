...
class Database(models.Model):
    ...
    config = models.CharField(unique=True, max_length=100, help_text=u'配置')
...
class Column(models.Model):
    ...
    other_enums = models.TextField(max_length=2000, help_text=u'未匹配的枚举值', default='', null=True, blank=True)
    is_deleted = models.BooleanField(default=False)
